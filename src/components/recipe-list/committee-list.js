...
import CommitteeListItem from '../recipe-list-item/committee-list-item';
import RecipeTable from '../recipe-table';
import './style.scss';
import ApiCommittee from '../../core/api-committee';

class CommitteeListNotExtended extends React.Component {
	sortTable = n => {
        ...
        return (
            <span>
                ...
                <div className='comp_recipe-list'>
                    {
                        items.map( ( value, index ) => {
                            return <CommitteeListItem key={ index } item={ value } committee_list={committee_list}/>;
                        } )
                    }
                </div>
            </span>
...
CommitteeListNotExtended.defaultProps = {
    items: []
};

CommitteeListNotExtended.propTypes = {
    items: PropTypes.array
};

const CommitteeList = hoistStatics( withTranslation()( CommitteeListNotExtended ), CommitteeListNotExtended );
